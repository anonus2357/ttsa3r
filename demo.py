...
def parse_seq_path(p):
    if os.path.isdir(p):
        ...
        # frame_interval = 1  #origin setting
        frame_interval = 3
...
def run_inference(args):
    ...
    # outputs, state_args = inference(views, model, device)   #offline images
    outputs, state_args = inference_recurrent(views, model, device)  # online videos/images
